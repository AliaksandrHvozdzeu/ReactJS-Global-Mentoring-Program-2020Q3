...
const MenuClosed = ({ action }) => (
  <button type="button" className="movie__menu movie-menu-closed" onClick={() => action(true)}>
    <div className="movie-menu-button"/>
  </button>
);

const MenuOpened = ({ action, editMovie, deleteMovie }) => (
  <div className="movie__menu movie-menu-opened">
    ...
    <button className="movie-menu-close" type="button" onClick={() => action(false)}>Close</button>
  </div>
);
